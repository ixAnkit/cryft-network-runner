...
```sh
git clone https://github.com/ixAnkit/cryft-network-runner.git
```
...
# e.g., ${HOME}/go/src/github.com/ixAnkit/cryftgo/build/metalgo
...
(See [here](https://github.com/ixAnkit/cryftgo/blob/master/network/peer/test_peer.go) for more information.)
...
# download from https://github.com/ixAnkit/cryftgo/releases
# or build
rm -rf ${HOME}/go/src/github.com/ixAnkit/cryftgo/build
cd ${HOME}/go/src/github.com/ixAnkit/cryftgo
./scripts/build.sh
...
go build -v \
-o ${HOME}/go/src/github.com/ixAnkit/cryftgo/build/plugins/srEXiWaHuhNyGwPUi444Tu47ZEDwxTWrbQiuD7FmgSAQ6X7Dy \
./plugin

# make sure binaries are built
find ${HOME}/go/src/github.com/ixAnkit/cryftgo/build
# for example
# .../build
# .../build/plugins
...
```bash
# replace execPath with the path to metalgo on your machine
METALGO_EXEC_PATH="${HOME}/go/src/github.com/ixAnkit/cryftgo/build/metalgo"
METALGO_PLUGIN_PATH="${HOME}/go/src/github.com/ixAnkit/cryftgo/build/plugins"
...
go build -v \
-o ${HOME}/go/src/github.com/ixAnkit/cryftgo/build/plugins/kM6h4LYe3AcEU1MB2UNg6ubzAiDAALZzpVrbX8zn3hXF6Avd8 \
./cmd/blobvm
...
cd ${HOME}/go/src/github.com/MetalBlockchain/timestampvm
go build -v \
-o ${HOME}/go/src/github.com/ixAnkit/cryftgo/build/plugins/tGas3T58KzdjcJ2iKSyiYsWiqYctRXaPTqBCA11BqEkNg8kPc \
./main
